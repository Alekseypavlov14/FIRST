...
class DashboardItem {
    ...
    changeView(view) {
        ...
        const current = this.data.timeframes[this.view.toLowerCase()].current;
        const previous = this.data.timeframes[this.view.toLowerCase()].previous;
    ...
    getDashboardData()
        ...
        selectors.forEach(s => {
            s.addEventListener('click', e => {
                ...
                s.classList.add('view-selector__item--active')

                const currentView = s.innerText.trim().toLowerCase()
